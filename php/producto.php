...
class Producto {
  ...
  function getUpdateSQL() {
    $sql = "UPDATE productos SET codigo='$this->codigo', descripcion='$this->descripcion',rebaja='$this->porcentajeRebaja', estareabajas='$this->estaRebajado',precio='$this->precio' WHERE codigo='$this->codigo' ";
